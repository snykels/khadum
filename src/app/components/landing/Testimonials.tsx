        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
<<<<<<< HEAD
              className="bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-800/60 border-2 border-gray-100 dark:border-gray-700 rounded-xl p-6 hover:border-[#34cc30] hover:shadow-lg transition-all"
            >
=======
...
>>>>>>> 8eb51cc93e5b4ccff945f13b2cd31105415d835a
              <div className="flex items-center gap-3">
                ...
                <div>
<<<<<<< HEAD
                  <div className="font-bold text-[#485869] dark:text-white">
                    {testimonial.name}
                  </div>
