...
<<<<<<< HEAD
    fetch("/api/auth/me").then(r => r.ok ? r.json() : null).then(d => {
      if (d?.user) setMe({ name: d.user.name || "مدير", role: d.user.role || "admin" });
    }).catch(() => {});
=======
>>>>>>> 8eb51cc93e5b4ccff945f13b2cd31105415d835a
...
<<<<<<< HEAD
                <div className="text-sm font-medium text-[#485869] dark:text-white">{me?.name || "مدير"}</div>
                <div className="text-xs text-gray-500 dark:text-gray-400">{me?.role === "admin" ? "مدير النظام" : me?.role === "supervisor" ? "مشرف" : me?.role || "مدير"}</div>
=======
              ...
              <div className="absolute left-0 top-full mt-2 w-64 bg-white dark:bg-[#1a1d24] rounded-xl shadow-2xl border border-gray-100 dark:border-[#2a2d36] overflow-hidden z-50">
                <div className="p-4 bg-gradient-to-l from-[#34cc30]/10 to-transparent border-b border-gray-100 dark:border-[#2a2d36]">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
<<<<<<< HEAD
                      <div className="font-bold text-[#485869] dark:text-white">{me?.name || "مدير"}</div>
                      <div className="text-[11px] text-[#34cc30] font-medium">{me?.role === "admin" ? "مدير النظام · صلاحيات كاملة" : me?.role === "supervisor" ? "مشرف" : "مدير"}</div>
=======
